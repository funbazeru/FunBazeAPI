...
public class NPCModifier {
  ...
  /**
   * The target me.kapdor.rpmodule.api.npc.
   */
  protected NPC npc;

  /**
   * Creates a new me.kapdor.rpmodule.api.npc modifier.
   *
   ...
   * @param createClone If a copy of each packet container should be done before sending.
   */
  public void send(Iterable<? extends Player> players, boolean createClone) {
   ...
   * @param createClone   If a copy of each packet container should be done before sending.
   */
  public void send(boolean createClone, Player... targetPlayers) {
