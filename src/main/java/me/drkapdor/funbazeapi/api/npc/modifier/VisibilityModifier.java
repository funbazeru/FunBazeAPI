...
public class VisibilityModifier extends NPCModifier {
  ...
  /**
   * Enqueues the change of the player list for the wrapped me.kapdor.rpjobs.api.npc.
   *
   * @param action The action of the player list change.
   * @return The same instance of this class, for chaining.
   * @since 2.5-SNAPSHOT
   */
  public VisibilityModifier queuePlayerListChange(PlayerInfoAction action) {
  ...
  /**
   * Enqueues the spawn of the wrapped me.kapdor.rpjobs.api.npc.
   *
   * @return The same instance of this class, for chaining.
   */
  ...
  /**
   * Enqueues the de-spawn of the wrapped me.kapdor.rpjobs.api.npc.
   *
   * @return The same instance of this class, for chaining.
   */
